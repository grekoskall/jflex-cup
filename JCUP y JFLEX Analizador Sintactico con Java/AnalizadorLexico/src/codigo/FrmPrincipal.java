...
public class FrmPrincipal extends javax.swing.JFrame {
        ...
        while (true) {
            ...
            switch (token) {
                ...
                case Division:
                    ...
                    break;
                case Parenthesis_a:
                    resultado += " <Parenthesis de apertura>\t" + lexer.lexeme + "\n";
                    break;
                case Parenthesis_c:
                    resultado += " <Parenthesis de cierre>\t" + lexer.lexeme + "\n";
                    break;
                case Llave_a:
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Analizador Sintactico", 2, 0));
    ...
    private void btnAnalizarSinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnalizarSinActionPerformed
        ...
        try {
            ...
            txtAnalizarSin.setForeground(new Color(25, 111, 62));
        } catch (Exception ex) {
            Symbol sym = s.getS();
